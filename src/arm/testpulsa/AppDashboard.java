...
public class AppDashboard extends ViewGroup {
	...
	public AppDashboard(Context context) {
		super(context, null);
	}

	public AppDashboard(Context context, AttributeSet attrs) {
		super(context, attrs, 0);
	}

	public AppDashboard(Context context, AttributeSet attrs, int defStyle) {
